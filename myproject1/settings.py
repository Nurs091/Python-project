...
SECRET_KEY = "django-insecure-kxlv_gte(fqesbgq1d5r0%84qzo!p!cqwi!w^(kll_-mbly-7q"
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Убедитесь, что правильно указана папка для шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
